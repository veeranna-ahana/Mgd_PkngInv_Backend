...
customerdataRouter.get("/allcustomerdata", async (req, res, next) => {
  try {
    misQueryMod(
...
customerdataRouter.get("/custdata", async (req, res, next) => {
  misQueryMod(
    "Select * from magodmis.cust_data order by Cust_name asc",
    (err, data) => {
      if (err) {
      ...
      console.log("resulttttttttttttttttttttttttttttttttttt");
    }
  );
});

customerdataRouter.post("/allcustcodename", async (req, res, next) => {
  try {
    misQueryMod(
...
customerdataRouter.post("/getcustomerdetails", async (req, res, next) => {
  try {
...
customerdataRouter.post("/customer", async (req, res, next) => {
  try {
...
customerdataRouter.post(`/customerupdate`, async (req, res, next) => {
...
customerdataRouter.post("/getcustomercontactdets", async (req, res, next) => {
...
// customerdataRouter.post('/getcustomercontactteledets', async (req, res, next) => {
...
customerdataRouter.post(`/customerassy`, async (req, res, next) => {
...
customerdataRouter.post("/customerinsassembly", async (req, res, next) => {
...
customerdataRouter.post("/chkassydupl", async (req, res, next) => {
...
customerdataRouter.post("/custbomparts", async (req, res, next) => {
...
customerdataRouter.post(`/getcustomerbomparts`, async (req, res, next) => {
...
// Bom Assembly Parts
customerdataRouter.post("/bomassemblyparts", async (req, res) => {
...
customerdataRouter.post("/getcustpartdetails", async (req, res, next) => {
...
customerdataRouter.post("/custbomassemblyparts", async (req, res, next) => {
...
customerdataRouter.post(`/getcustomer`, async (req, res, next) => {
...
customerdataRouter.post(`/customersdrawings`, async (req, res, next) => {
  //    console.log(req.body);
  try {
    const custcode = req.body.custcode;
...
customerdataRouter.post(`/customerorders`, async (req, res, next) => {
...
customerdataRouter.post(`/orderstatus`, async (req, res, next) => {
  try {
...
customerdataRouter.post(`/orderschedule`, async (req, res, next) => {
  console.log(req.body);
  try {
...
customerdataRouter.post(`/orderschtasks`, async (req, res, next) => {
  console.log(req.body);
  try {
    const orderno = req.body.orderno;
...
customerdataRouter.post(`/orderdetails`, async (req, res, next) => {
  console.log(req.body);
  try {
    const orderno = req.body.orderno;
    misQueryMod(
...
customerdataRouter.post(`/orderinvoices`, async (req, res, next) => {
  try {
    console.log(req.body);
    const orderno = req.body.orderno;
    misQueryMod(
...
customerdataRouter.post(`/orderinvdwg`, async (req, res, next) => {
  console.log(req.body);
...
customerdataRouter.post(`/schdets`, async (req, res, next) => {
  console.log(req.body);
...
customerdataRouter.post(`/schtasksdets`, async (req, res, next) => {
  try {
...
customerdataRouter.post(`/printduereport`, async (req, res, next) => {
...
customerdataRouter.post(`/customermtrlstock`, async (req, res, next) => {
  try {
    const custcode = req.body.custcode;
...
customerdataRouter.post(`/getmtrlrvlist`, async (req, res, next) => {
  try {
...
customerdataRouter.post(`/customermtrlreceipts`, async (req, res, next) => {
  try {
    const custcode = req.body.custcode;
...
customerdataRouter.post(`/customermtrlrectdetails`, async (req, res, next) => {
  try {
...
customerdataRouter.post(
  `/customermtrlpartsreturned`,
  async (req, res, next) => {
    try {
      const custcode = req.body.custcode;
...
customerdataRouter.post(`/updatebomassembly`, async (req, res, next) => {
...
customerdataRouter.post(`/deletebomassmparts`, async (req, res, next) => {
...
customerdataRouter.post(`/customerduelist`, async (req, res, next) => {
  console.log(req.body);
  try {
    const custcode = req.body.custcode;
    if (!custcode) return res.send(createError.BadRequest());
...
customerdataRouter.post(`/customeroverduelist`, async (req, res, next) => {
  console.log(req.body);
  try {
    const custcode = req.body.custcode;
...
customerdataRouter.post(`/customerduesoverdues`, async (req, res, next) => {
  try {
    const custcode = req.body.custcode;
    if (!custcode) return res.send(createError.BadRequest());
...
customerdataRouter.post(`/pprcustomerduelist`, async (req, res, next) => {
  console.log(req.body);
  try {
    const custcode = req.body.custcode;
    if (!custcode) return res.send(createError.BadRequest());
...
customerdataRouter.post(`/sendmailwithattachment`, async (req, res, next) => {
...
customerdataRouter.post(`/customerdlinvform`, async (req, res, next) => {
  console.log(req.body);
  try {
    const dcinvno = req.body.dcinvno;
...
customerdataRouter.post(`/customerdlinvformtaxdets`, async (req, res, next) => {
  console.log(req.body);
  try {
    const dcinvno = req.body.dcinvno;
    if (!dcinvno) return res.send(createError.BadRequest());
...
customerdataRouter.post(`/customerduessummary`, async (req, res, next) => {
  console.log(req.body);
  try {
    const custcode = req.body.custcode;
    if (!custcode) return res.send(createError.BadRequest());
